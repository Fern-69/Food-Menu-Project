...
const mensajeAleatorio = ["!Muy Buena elección!",
                  "!Seguro que es de su agrado¡",
                  "¡Muy saludable!", "¡De lo mejor del menú!",
                  "¡Producto de gran calildad!",
                  "¡Hecho con las mejores materias primas!",
  ...
  for (const [categoria, platos] of Object.entries(menuExtras)) {
    while (true) {
      ...
      if (extraElegido) {
        ...
        //Mostrar mensaje aleatorio Extras
        const ordenAleatorio = Math.floor(Math.random() * mensajeAleatorio.length);
        alert(mensajeAleatorio[ordenAleatorio]);
  ...
  for (const [categoria, platos] of Object.entries(menuData)) {
    while (true) {
      ...
      if (platoElegido) {
        ...
        //Mostrar mensaje aleatorio Menu
        const ordenAleatorio = Math.floor(Math.random() * mensajeAleatorio.length);
        alert(mensajeAleatorio[ordenAleatorio]);
